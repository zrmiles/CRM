  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="page-subtitle">Воронка продаж по стадиям и конверсии.</p>
      </div>

      <section className={`grid gap-3 rounded-lg bg-white p-4 shadow-sm ${canSeeAll ? 'md:grid-cols-4' : 'md:grid-cols-3'}`}>
